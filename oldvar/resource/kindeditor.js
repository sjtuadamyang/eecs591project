...
KE.lang = {
	...
	noColor : 'No Color',
	invalidImg : "Please input a valid URL \n Allowed jpg,gif,bmp,png",
	invalidMedia : "Please input a valid URL \n Allowed swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb",
	invalidWidth : "The width must be number.",
	invalidHeight : "The height must be number.",
	invalidBorder : "The border must be number.",
	invalidUrl : "Please type valid URL.",
    invalidAccessory: "Please input a valid file,Just allow rar,zip",
...
plugins.plainpaste = {
	comment : 'Please paste the content  using keyboard shortcut(Ctrl+V)'
};
