...
public class IndexAll {
	...
	public IndexAll(int maxuserid,int num,String ip) {
	...
	public long add() {
		...
		Random ran = new Random();
			for (int i = 0; i < this.num; ++i) {
				System.out.println(HttpTookit.doGetAll("http://"+ip+"/index.php?username="+ran.nextInt(maxuserid)));
	...
	public static void main(String args[]) {
		IndexAll add = new IndexAll(100,1,"localhost");
